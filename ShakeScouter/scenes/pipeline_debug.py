...
from ShakeScouter.scenes.ingame import StageScene, KingScene, ResultScene, ErrorScene
from ShakeScouter.scenes.ingame.wave_debug_scene import DebugWaveScene
